// Generated by @wagmi/cli@1.0.0 on 5/26/2023 at 4:28:20 PM
import {
  useContractRead,
...
export const bountyXHyperDropABI = [
  ...
  { stateMutability: 'nonpayable', type: 'function', inputs: [], name: 'renounceOwnership', outputs: [] },
  {
    ...
    type: 'function',
    inputs: [{ name: 'x', internalType: 'address', type: 'address' }],
    name: 'superNewClaim',
    outputs: [],
  },
  {
...
/**
 * Wraps __{@link useContractRead}__ with `abi` set to __{@link bountyXHyperDropABI}__ and `functionName` set to `"superNewClaim"`.
 *
 *
 */
export function useBountyXHyperDropSuperNewClaim<
  TFunctionName extends 'superNewClaim',
  TSelectData = ReadContractResult<typeof bountyXHyperDropABI, TFunctionName>
>(
  config: Omit<UseContractReadConfig<typeof bountyXHyperDropABI, TFunctionName, TSelectData>, 'abi' | 'address' | 'functionName'> & {
    chainId?: keyof typeof bountyXHyperDropAddress
