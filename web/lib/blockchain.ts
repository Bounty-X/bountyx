// Generated by @wagmi/cli@1.0.0 on 5/23/2023 at 2:57:59 PM
import {
  useContractRead,
 ...
 */
export function getBountyXHyperDrop(config: Omit<GetContractArgs, 'abi'>) {
  return getContract({ abi: bountyXHyperDropABI, ...config })
}
...
export function readBountyXHyperDrop<TAbi extends readonly unknown[] = typeof bountyXHyperDropABI, TFunctionName extends string = string>(
  ...
  return readContract({ abi: bountyXHyperDropABI, ...config } as unknown as ReadContractConfig<TAbi, TFunctionName>)
}

/**
 * Wraps __{@link writeContract}__ with `abi` set to __{@link bountyXHyperDropABI}__.
 */
export function writeBountyXHyperDrop<TFunctionName extends string>(
  config:
    | Omit<WriteContractPreparedArgs<typeof bountyXHyperDropABI, TFunctionName>, 'abi'>
    | Omit<WriteContractUnpreparedArgs<typeof bountyXHyperDropABI, TFunctionName>, 'abi'>
) {
  return writeContract({ abi: bountyXHyperDropABI, ...config } as unknown as WriteContractArgs<typeof bountyXHyperDropABI, TFunctionName>)
}
...
export function prepareWriteBountyXHyperDrop<TAbi extends readonly unknown[] = typeof bountyXHyperDropABI, TFunctionName extends string = string>(
  ...
  return prepareWriteContract({ abi: bountyXHyperDropABI, ...config } as unknown as PrepareWriteContractConfig<TAbi, TFunctionName>)
}
...
export function watchBountyXHyperDropEvent<TAbi extends readonly unknown[] = typeof bountyXHyperDropABI, TEventName extends string = string>(
  ...
  return watchContractEvent({ abi: bountyXHyperDropABI, ...config } as WatchContractEventConfig<TAbi, TEventName>, callback)
}
